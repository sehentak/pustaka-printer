...
public class PrinterCommand {
   ...
   public static byte[] POS_Set_CodePage(int page){
	 ...
	 */
	public synchronized static byte[] POS_Print_Text(String pszString, String encoding, int codepage,
										int nWidthTimes, int nHeightTimes, int nFontType) {

		if (codepage <0 || codepage >255 || pszString == null || "".equals(pszString) || pszString.length() < 1 || encoding == null) {
			return null;
		}
